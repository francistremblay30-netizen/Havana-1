...
children.push(
  ...
  P("L'occupation hivernale projetée ne repose pas sur une hypothèse générale mais sur un produit qui existe : les unités Coolbox sont exploitées l'hiver sur d'autres destinations du réseau (fiches de ventes par site, annexe J). À Havana, elles n'ont été exploitées qu'en été jusqu'en 2026. Le plan retient pour les unités du site une occupation hivernale de " + pct(M.hypotheses.coolbox_occ_hiver["1"], 0) + " en An 1 à " + pct(M.hypotheses.coolbox_occ_hiver["5"], 0) + " en An 5 (chalets : " + pct(M.hypotheses.chalets_occ_hiver["1"], 0) + " à " + pct(M.hypotheses.chalets_occ_hiver["5"], 0) + "), sous les taux observés dans le réseau."),
...
children.push(
  ...
  P("Le premier hiver repose sur des produits nommés : l'hôtel (17 chambres) et la salle de conférence livrés en juillet 2027, les 16 chalets hivernisés à l'automne 2027 et les 9 nouvelles unités Coolbox."),
...
children.push(
  ...
  dataTable(["Modalité", "Proposition"], [
    ...
    ["Garanties", "Hypothèque de premier rang sur les trois lots ; hypothèque mobilière sur les équipements (rapport 2023, 2,05 M$) et sur les 9 nouvelles unités Coolbox ; cession d'assurances ; cautionnements des actionnaires."],
