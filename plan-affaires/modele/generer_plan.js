...
children.push(
  ...
  dataTable(
    ...
    [
      ...
      ["Piscine centrale, Aqua Bar et café-bar", "1", "Inclus", "Été"],
      ["Lac, plage de sable et palapas", "1", "Inclus", "Été"],
      ["Cantine, jeux gonflables, concessions", "—", "Variable", "Été"],
    ],
    [3600, 1300, 2300, 2448], { numericFrom: 1 },
  ),
  spacer(),
  twoPlaceholders("Vue aérienne des terrains de camping", "Chalets", 3300, "actifs_terrains", "actifs_chalets"),
  spacer(),
